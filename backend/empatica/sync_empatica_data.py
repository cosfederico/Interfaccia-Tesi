...
def sync_empatica_data(subject_dir):
    ...
    data = pd.read_csv(os.path.join(subject_dir, 'data.csv'), sep=';')
    ...
    bvp.to_csv(os.path.join(subject_dir, 'bvp.csv'))
    bvp.to_csv(os.path.join(subject_dir, 'systolic_peaks.csv'))